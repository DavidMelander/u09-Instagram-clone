...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        // 4) get a download URL from fireB storage and update the orignial post with image
                ...
                <div>   
                    ...
                    <div>
                        ...
                        <div className='mt-5 sm:mt-6'>
                            ...
                            className="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base
